...
5. Tick **Interstate (IGST)** only if the customer is in another state **and** GST is on.
6. Click **Complete sale**.
7. Click **Share bill** (phone share sheet or WhatsApp with a downloaded PDF). **Print** if you have a printer.
...
1. **Dashboard** — **Today’s sales** should move
2. **Inventory** — sold product quantity should be lower
3. **Sales** — a sale number appears with status **PAID** or **PARTIAL** / **PENDING**
...
1. Open **Suppliers**, create the company you buy from
2. Open **Purchases**, choose that supplier, **Add item**, enter quantity and purchase price, then **Record purchase**

That **increases** stock. Details: [Suppliers](suppliers.md) and [Purchases](purchases.md).
